...
Apparently, there are 5098 rows (points) being excluded. We can see which ones they are by doing the following:

```{r}

test1$classcode[is.na(test1$weight)]
