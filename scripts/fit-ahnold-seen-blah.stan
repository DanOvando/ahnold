...
segment(region_species_betas,counter, regions_per_species[i]) ~ normal(0, sigma_region_species[i]);
...
sigma_density_species ~ cauchy(0,cauchy_2 );

sigma_year_species ~ cauchy(0, cauchy_2);

sigma_region_species ~ cauchy(0, cauchy_2);
