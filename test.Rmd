...
defense_theme <- theme_ipsum(base_size = 22, axis_title_size = 24,
                             strip_text_size = 22)

theme_set(defense_theme)
...
# Sys.time() - a
# load("~/PhD/scrooge/results/d1.0/scrooge-plots.Rdata")

# load("~/PhD/skynet/results/d1.1/skynet-plots.Rdata")
...
temp <- read_rds(here("results","v3.0","figures","ci_mpa_plot.RDS"))
...
![:scale 10%](presentations/mpa_poster_fullsize.jpg)
...
![:scale 90%](https://upload.wikimedia.org/wikipedia/commons/7/7e/Mudra-Naruto-KageBunshin.svg)
