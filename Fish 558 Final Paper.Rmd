...
title: The Effects of the Marine Life Protection Act on Fish Densities in the Channel
  Islands - FISH 558 Final Project
author: "Dan Ovando"
...
$$ \hat{d_{f,s,y}} = \beta_{1}fished_{f} + \beta_{2}YearsMLPAMpas_{s,y} + \beta_{3}FxM{f,s,y} +
  \sum\beta_{4}region_{s} + \sum\beta_{5}trophic_{f} + ... $$

  $$\beta_{6}linf_{f} + \beta_{7}vbk_{f} + \beta_{8}temp_{s,y} +
  \beta_{9}vis_{s,y} + $$

  $$ \beta_{10}templag1_{s,y} + \beta_{11}templag2_{s,y} + \beta_{12}templag3_{s,y} +
  \beta_{13}templag4_{s,y} + \beta_{14} $$
