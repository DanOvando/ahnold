...
pre_cor_plot <- pre_treat_corr %>% 
  ...
  geom_point() + 
  geom_abline(aes(intercept = 0, slope = 1), linetype = 2, color = "red") + 
  labs(x = "Non-Targeted Abundance Index", y = "Targeted Abundance Index", caption = glue::glue("Pearson correlation coefficient = {pre_cor}"))
