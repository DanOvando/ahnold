...
seen_model <- lme4::lmer(log_density ~  targeted + post_mpa + targeted:factor_year + site_side + mean_vis + mean_canopy +  (1|classcode) + (1 | factor_year) + mean_enso + mean_pdo + lag1_enso + lag2_enso + lag1_pdo + lag2_pdo + catch, data = seen_data)
