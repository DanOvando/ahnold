...
raw_length_vars <- paste(c('factor_year','observer', 'site', 'side', 'mean_vis', 'mean_canopy'), collapse = '+')

supplied_density_vars <- paste(c('factor_year', 'side', 'side','mean_kelp', 'mean_vis'), collapse = '+')
